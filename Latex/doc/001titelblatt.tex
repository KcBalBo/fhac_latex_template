\begin{titlepage}
	...
	\centering \begin{minipage}[t]{17cm}
		\centering \bfseries \large Thema der Arbeit
		\medskip
	\end{minipage}
	...
	\begin{minipage}[t]{9cm}
		\centering Vorname Nachname \\ Matr.-Nr.: 00000000    % --> Eigenen Namen einfügen
	\end{minipage}
	...
	\centering \begin{minipage}[t]{9cm}
		\centering \begin{tabular}{ll}
			Referent: & Prof. Dr. Vorname Nachname\\ 				% --> Namen des Betreuers einfügen
			%Referent: & Prof. Dr. rer. nat. Vorname Nachname \\
			Korreferent: & Vorname Nachname,  M.Sc. \\				% --> Namen des Betreuers einfügen
